...
//--------------------- Interfaces -------------------------------------------
  ...
  IMFTopology = interface(IMFAttributes)
    ['{83CF873A-F6DA-4bc8-823F-BACFD55DC433}'{IID_IMFTopology}]
  ...
  IMFTopologyNode = interface(IMFAttributes)
    ['{83CF873A-F6DA-4bc8-823F-BACFD55DC430}'{IID_IMFTopologyNode}]
  ...
  IMFMediaSession = interface(IMFMediaEventGenerator)
    ['{90377834-21D0-4dee-8214-BA2E3E6C1127}'{IID_IMFMediaSession}]
...
//Interface IMFClock
  IMFClock = interface(IUnknown)
    ['{2eb1e945-18b8-4139-9b1a-d5d584818530}'{IID_IMFClock}]
  ...
  IMFGetService = interface(IUnknown)
    ...
    function GetService(const  guidService: tGUID; const riid: tGUID; out Obj): HResult; stdcall;
...
//--------------------- IMFRateControl
  IMFRateControl = interface(IUnknown)
    ['{88ddcd21-03c3-4275-91ed-55ee3929328f}'{IID_IMFRateControl}]
...
type
  ...
  cwMFSESSION_SETTOPOLOGY_FLAGS = type Byte;
(*
...
type
  ...
  _MFCLOCK_CHARACTERISTICS_FLAGS = type Byte;
(*
...
type
  ...
  _MFNetCredentialOptions = type byte;
(*
...
type
  ...
  _MFNetAuthenticationFlags = type byte;
(*
...
type
  ...
  _MFNETSOURCE_STATISTICS_IDS = type LongWord;
(*
