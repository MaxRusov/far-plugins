...
type
  ...
  MFVideoAspectRatioMode = type LongWord;
(*
...
type
  ...
  MFVideoRenderPrefs = type LongWord;
(*
  MFVideoRenderPrefs                         = (
...
type
  ...
  MFVP_MESSAGE_TYPE = type LongWord;
(*
  MFVP_MESSAGE_TYPE                  = (
...
type
  ...
  _MFVideoMixPrefs = type LongWord;
(*
  _MFVideoMixPrefs                           = (
...
type
  ...
  _EVRFilterConfig_Prefs = type LongWord;
(*
...
type
  ...
  _MF_SERVICE_LOOKUP_TYPE = type LongWord;
(*
