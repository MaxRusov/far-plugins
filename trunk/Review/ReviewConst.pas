...
interface
  ...
  const
   ...
   {$endif Far3}
    ...
    cRegPath = 'Software\Far Manager\Plugins\Review';  { Äëÿ ñòàğûõ ñóáïëàãèíîâ... }
  ...
  var
    ...
    optSmoothScale    :Boolean = True;        { Èñïîëüçîâàòü ñãëàæèâàíèå ïğè óâåëè÷åíèè }
    optShowInfo       :Integer = 0;

    optDraftDelay     :Integer = 150; {ms}
    optSyncDelay      :Integer = 250; {ms}    { Çàäåğæêà ñìåíû êàğòèíêè â QuickView (òîëüêî åñëè âêëş÷åí optAsyncQView) }
