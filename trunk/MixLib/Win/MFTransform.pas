...
//  TIMFTransform = interface;
 ...
 {$EXTERNALSYM _MFT_INPUT_DATA_BUFFER_FLAGS}
  _MFT_INPUT_DATA_BUFFER_FLAGS = type LongWord;
(*
...
*)
  ...
  _MFT_OUTPUT_DATA_BUFFER_FLAGS = type LongWord;
(*
...
type
  ...
  _MFT_INPUT_STREAM_INFO_FLAGS = type LongWord;
(*
...
type
  ...
  _MFT_OUTPUT_STREAM_INFO_FLAGS = type LongWord;
(*
...
type
  ...
  _MFT_PROCESS_OUTPUT_STATUS = type LongWord;
(*
...
type
  ...
  _MFT_MESSAGE_TYPE = type LongWord;
(*
  _MFT_MESSAGE_TYPE                    = (
...
{ How to implement this?   I think, we could do without with Delphi
  ...
  function MFCreateTransformActivate(const ppActivate: IMFActivate): HResult; stdcall;
