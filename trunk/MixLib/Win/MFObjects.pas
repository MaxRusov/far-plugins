...
type
  TRefClsID = TGUID;
  REFGUID = tGUID;                                  //updt 090812 not sure
  REFIID =  pGUID;                                  //updt 090812 not sure, REFIID in Direct3d replaced by pGUID
  CLSID =  tCLSID;                                  //updt 090812 in ActiveX
  REFCLSID = tRefCLSID;                             //updt 090812 in Direct3d
  REFPROPVARIANT = tPropVariant;                    //updt 090812 pretty sure of this one
  PUINT32 = ^Uint32;                                //updt 090812
...
type
  ...
  _MFVideoInterlaceMode = type LongWord;
(*
...
type
  ...
  _MFVideoTransferFunction = type LongWord;
(*
...
type
  ...
  _MFVideoPrimaries = type LongWord;
(*
  _MFVideoPrimaries              = (
...
type
  ...
  _MFVideoLighting = type LongWord;
(*
  _MFVideoLighting           = (
...
type
  ...
  _MFVideoTransferMatrix = type LongWord;
(*
...
type
  ...
  _MFVideoChromaSubsampling = type LongWord;
(*
...
type
  ...
  _MFStandardVideoFormat = type LongWord;
(*
